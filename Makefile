...
#    Updated: 2023/04/30 14:21:45 by pharbst          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	:= common_utils.c hooks.c main.c player.c raycaster.c color_utils.c draw_cubes.c draw_utils.c init_utils.c map.c scene.c set_pixel.c error_handling.c input.c player_utils.c cub_fps.c
# Parsing
